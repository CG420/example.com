...
gulp.task('watch', function(){
  ...
  gulp.watch('.//public/src/scss/**/*.scss', ['build-resume']);
  gulp.watch('.//public/src/scss/**/*.scss', ['build-contact']);
  gulp.watch('.//public/src/scss/**/*.scss', ['build-thanks']);
});

gulp.task('build-resume', function(){
  //Create an unminified version
  var full = gulp.src([
    'public/src/scss/resume.scss'
  ])
  . pipe(scss())
